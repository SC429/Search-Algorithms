...
public class Sorting {
	...
	public static void SelectionSort(long[] a) {
		...
		for (int i = 0; i < n-1; i++) {
			int minIndex = i; //index of minimum of the array
			...
			//long temp = a[minIndex]; //switch to utilize exch method
			//a[minIndex] = a[i];
			//a[i] = temp;
		}
	}
  ...
  private static void merge(long[] a, long[] aux, int lo, int mid, int hi) {
	...
	//-----------------------------------------------------------------------
	// TODO: Implement Optimized Quicksort below
	//-----------------------------------------------------------------------
...
//		}
	...
	//---------------------------------------------------------------------------
	// TODO: Implement Non-Recursive MergeSort below
	//---------------------------------------------------------------------------
...
//		while (i < a.length) {
//			while (j < a.length - i) {
//				merge(a, aux, j, i + j-1, j + 2*i-1); //retrace this part right here
//				j+= 2*i;
//			}
//			i*=2;
//		}
	...
	//---------------------------------------------------------------------
	// TODO: Apply MergeSort to the Linked List
	//---------------------------------------------------------------------
